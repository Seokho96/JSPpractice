...
<%
    Calendar cal = Calendar.getInstance();     //  모델 2에서는 컨트롤러에 적자
     cal.set(Calendar.DATE, 1);    // 오늘 날짜가 7/31 이면 7/1로 세팅해준다
    
     String syear = request.getParameter("year");
     String smonth = request.getParameter("month");
     
     int year = cal.get(Calendar.YEAR);
     if(nvl(syear) == false){   // parameter가 넘어왔을 때
     ...
     cal.set(year, month - 1, 1);     // 연 월 일 셋팅 완료  -> 2020 07 31
...
%> 
<div align="left">
<button type="button" id="list">게시판</button>
