...
public class CalendarDao {
	...
	public CalendarDto calDetail(int seq) {
		...
		try {
			conn = DBConnection.getConnection();
			  System.out.println("1/6 calDetail success"); 
			  
			psmt = conn.prepareStatement(sql);
			psmt.setInt(1, seq);
			System.out.println("2/6 calDetail success"); 
			
			rs = psmt.executeQuery();
			System.out.println("3/6 calDetail success");
   ...
   public boolean updateCalendar(CalendarDto cal, int seq) {
		...
		try {
			conn = DBConnection.getConnection();
          System.out.println("1/6 updateCalendar success"); 
			...
			psmt.setString(5, cal.getId());
			
			System.out.println("2/6 updateCalendar success"); 
			
			 count = psmt.executeUpdate();
			 System.out.println("3/6 updateCalendar success"); 
